import dirIcon from '@/assets/img/icon/dir.png'
import defaultFileIcon from '@/assets/img/icon/file.png'
...
class DefaultIconProvider implements FileIconProvider {
  ...
  public getFileIconUrl(name: string, md5?: string): string {
    ...
    if (!ruleObj) {
      ...
      return new URL(`/src/assets/img/icon/${ruleObj.iconName}.${ruleObj.suffix || this.config.defaultSuffix}`, import.meta.url).href
    }
